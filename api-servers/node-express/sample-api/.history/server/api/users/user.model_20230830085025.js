...
UserSchema.methods = {
    ...
    authenticate: async function (plainText) {
        try {
            ...
            //
            const passwordAttempt = await this.encryptPassword(plainText)
    ...
    encryptPassword: async function (password) { // EDIT THIS FUNCTION TO COMBINE IT WITH SETTINGS
        ...
        return new Promise((resolve, reject) => {
            ...
            const iterations = 10000, keyLength = 64, algorithm = 'sha1' // sha512
...
const PublicMethods = {
    ...
    validate: function validate(obj, add) {
        ...
        if (add) {
            ...
            //     const dash = obj.hasOwnProperty("dashboard") && obj.dashboard
            //     delete obj.dashboard
            //     const auths = settings.getPossibleAuthentications(dash)
        ...
        for(const k of ["first_name", "last_name", "other_names"]){
