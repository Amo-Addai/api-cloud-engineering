 ...
 * Iterates over all the properties of the event payload and serializes theem.
 * If a property has toJSON method, it will infer the return type of that m...
 * @template T Event data type
 */
export type SerializedEventPayload<T> = 
    T extends object
    ? {
