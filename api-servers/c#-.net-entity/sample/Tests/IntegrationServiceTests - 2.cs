...
namespace Sample.Slicer.API.Tests.Services
{
    ...
    public class IntegrationServiceTests
    {
        ...
        public IntegrationServiceTests()
        {
            ...
            // TODO: Can Inject the mock HttpClient into the service right here
            // _service.HttpClient = _httpClient;
            // _testService.HttpClient = _httpClient;
        }

        // Can also Inject new mock HttpClient into _service
        public IntegrationServiceTests(string dummy) // TODO:
        {
            var apiVariables = new ApiVariables
            {
                ApiUrl = ValidApiUrl, ApiKey = ValidApiKey
            };
            var apiVariablesMock = new Mock<IOptions<ApiVariables>>();

            apiVariablesMock.Setup(config => config.Value).Returns(apiVariables);
            ...
            _service = new IntegrationService(apiVariablesMock.Object)
            {
                ...
                {
                    BaseAddress = new Uri(apiVariables.ApiUrl)
                }
            };
        ...
        public async Task GetProjectAsync_ShouldReturnProjectOutputDto_WhenProjectExists()
        {
			...
			*/
            ...
            // TODO: check - Inject the mock HttpClient into the service
            _service.HttpClient = _httpClient;
