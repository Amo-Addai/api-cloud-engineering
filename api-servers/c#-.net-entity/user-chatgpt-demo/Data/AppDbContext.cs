...
namespace ChatGPTBackend.Data
{
    ...
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<Sample>? Queries { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sample>().HasKey(q => q.Id);

            // Set Id Primary Key to Auto-increment
            modelBuilder.Entity<User>().Property(u => u.Id).ValueGeneratedOnAdd(); 
            modelBuilder.Entity<Sample>().Property(q => q.Id).ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<Sample>().HasData(
                new Sample { SampleText = "sample1", ResponseText = "response1" },
                new Sample { SampleText = "sample2", ResponseText = "response2" }
            );
            */
        }
    }
